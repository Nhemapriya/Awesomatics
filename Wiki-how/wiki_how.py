...
im = PIL.Image.open('./meta/logo.png')
...
pred = tk.Label(windo, text="Wiki-How", width=30, height=2, fg="white",bg="grey",
                font=('times', 25, ' bold '))
pred.place(x=274, y=10)

lab = tk.Label(windo, text="Explore and learn", width=18, height=1, fg="white",bg="blue2",
                font=('times', 16, ' bold '))
